                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $i++}} </td>
                                            <td>                                            <img src="{{ asset($brand->logo)}}" class="img-fluid" style="width:70px">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('backside.brand.destroy',$id)}}" method="POST" class="d-inline-block" onsubmit="return confirm('Are your sure to delete?')">
                                           @csrf
                                           @method('DELETE')
