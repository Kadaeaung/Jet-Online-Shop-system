        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__language">
                ...
                <ul>
                    ...
                    <li><a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> Sign Out </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="{{route('register')}}"><i class="fa fa-user"></i> Resgister</a>
                            </div>
                         <div class="header__top__right__auth">
                                <a href="{{route('login')}}"><i class="fa fa-user"></i> Login</a>
                            </div>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="javascript:void(0)">
                                ...
                                <input type="text" id="searchvalue" placeholder="What do yo u need?">
                                <button  class="site-btn searchbtn" type="submit" >SEARCH</button>
                            </form>
                        </div>
