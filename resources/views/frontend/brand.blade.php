                                    ...
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            ...
                                            <ul class="product__item__pic__hover">
                                                ...
                                                <li><a href="javascript:void(0)" class="addtocartBtn" data-id="{{$id}}" data-name="{{$name}}" data-codeno="{{$codeno}}" data-unitiprice="{{$unitpirce}}" data-discount="{{$discount}}" data-photo="{{$photo}}"><i class="fa fa-shopping-cart"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            @if($discount)
                                            <div class="product__item__price">{{$discount}} <span>{{$unitpirce}}</span> </div>
                                            @else
                                          <div class="product__item__price"> <span>{{$unitpirce}}</span> </div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
