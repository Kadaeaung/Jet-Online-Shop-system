...
class CategoryController extends Controller
{
    ...
    {
        //
        $validator= Validator::make($request->all(),['name' => 'required|string|max:255|unique:categories','photo' => 'required|mimes:jpeg,bmp,png,jpg']);
    ...
    public function update(Request $request, $id)
    {
        ...
        }else
        {
         ...
         $status=200;
         $result= new CategoryResource($category);
         $message= 'Category Update successsfully';
