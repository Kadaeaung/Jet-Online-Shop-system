...
class SubCategoryController extends Controller
{
    ...
    {
        //
        $validator= $request->validate(['name' => ['required','string','max:255','unique:subcategories']]);
        if($validator)
        {
        ...
        return redirect()->route('backside.subcategory.index')->with("successMsg",'New Subcategory is ADDED is your data');
    }
    else
    {
